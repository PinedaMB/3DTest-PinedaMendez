...
def plotPlaneLine(xg,yg,zg,xh,yh,xhg,yhg,hitcolor):
    plt.title("3D Test - Pineda Brayan")
    ...
    plt.text(150, 20, "A = 50")
    plt.text(150, 30, "A1 = 300")
    plt.text(150, 40, "A2 = 200")
...
while True:
    axis=input("Teclea el eje que deseas visualizar 'x,y,z' o teclee '18390039' para salir ?:")
    ...
    if axis== '18390039': #Pide el número de contról para salir del programa
